function [Y_entry, Z_entry,X_list]=Gillespie_linear_nofeedback_v6(lambda_p, lambda_n, lambda_d, delay_mean, delay_cv,initial_particle_num, A,repeat_time)
...
%     temp_degradation_list=NaN(max_n,2);
    ...
    while (t<max_t)&&(iter<max_iter)
        ...
        prop_vector(2) = phos(x(2:3),0,1,vol); % protein phosphorylation at peri
