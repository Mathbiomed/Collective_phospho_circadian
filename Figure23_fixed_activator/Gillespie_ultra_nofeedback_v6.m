function [Y_entry, Z_entry,X_list]=Gillespie_ultra_nofeedback_v6(lambda_p, lambda_n, lambda_d, delay_mean, delay_cv,initial_particle_num, A,repeat_time)
...
parfor repeat_i=1:repeat_time
    ...
    while (t<max_t)&&(iter<max_iter)
        ...
        prop_vector(2) = phos(x(2:3),threshold,1,vol); % protein phosphorylation at peri
