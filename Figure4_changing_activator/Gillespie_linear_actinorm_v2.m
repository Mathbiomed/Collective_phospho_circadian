function X_list=Gillespie_linear_actinorm_v2(lambda_p, lambda_n, lambda_d, phos_deg_ratio, delay_mean, delay_cv, activator,repeat_time)
...
%         A=interp1(L_A*floor(t/L_A):L_A*(floor(t/L_A)+1),[activator,activator(1)],t);
